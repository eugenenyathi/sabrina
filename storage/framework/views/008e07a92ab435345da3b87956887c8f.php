...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'absolute pointer-events-none top-1/2 -translate-y-1/2 left-3 text-gray-400']); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'absolute pointer-events-none top-1/2 right-8 -translate-y-1/2 text-gray-400 ']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalce0070e6ae017cca68172d0230e44821)): ?>
<?php $attributes = $__attributesOriginalce0070e6ae017cca68172d0230e44821; ?>
...
<?php endif; ?>
            ...
            <!-- INLINE LABEL -->
            <!--[if BLOCK]><![endif]--><?php if($label && $inline): ?>
                <label for="<?php echo e($uuid); ?>" class="absolute pointer-events-none text-gray-500 duration-300 transform -translate-y-1 scale-75 top-2 origin-[0] rounded px-2 peer-focus:px-2 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-1 <?php if($inline && $icon): ?> left-9 <?php else: ?> left-3 <?php endif; ?>">
                    <?php echo e($label); ?>
        ...
        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
    </div><?php /**PATH C:\Users\eugen\Documents\Workspace\sabrina-live\storage\framework\views/6800e5d5897c04437bfda73e7b1e913d.blade.php ENDPATH**/ ?>