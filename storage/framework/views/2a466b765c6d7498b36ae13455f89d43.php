...
<?php endif; ?>
<?php $component->withAttributes(['wire:submit.prevent' => 'updateApplication','enctype' => 'multipart/form-data','class' => 'w-2/3 ']); ?>
                ...
                <div class="w-full flex flex-col justify-center items-center">
                    ...
                    <div class="relative" @mouseover=" showLabel = true", @mouseout=" showLabel = false">
                        <div class="size-48 rounded-full overflow-hidden mb-3 shadow cursor-pointer group">
                            <img x-show="showDBImg" src="<?php echo e(asset('/storage/' . $this->profile_url)); ?>"
                                alt="no-profile-img"
...
<?php $component = Mary\View\Components\Icon::resolve(['name' => 'o-camera'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
$message = $__bag->first($__errorArgs[0]); ?>
                        <span class="text-red-400 text-xs mt-1"><?php echo e($message); ?></span>
                    <?php unset($message);
...
<?php $component = Mary\View\Components\Textarea::resolve(['label' => 'Bio','hint' => 'Max 1000 chars'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('textarea'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Mary\View\Components\Textarea::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'bio','placeholder' => 'Why are running for office ...','rows' => '5','class' => 'focus:outline-orange-500 focus:border-orange-500 border-orange-500 peer-focus:label:text-orange-500']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                ...
                <div class="mb-2">
                    <?php if (isset($component)) { $__componentOriginaleda28cbc945270b2059ee861cf34a6bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginaleda28cbc945270b2059ee861cf34a6bc = $attributes; } ?>
<?php $component = Mary\View\Components\Textarea::resolve(['label' => 'Catch phrase','hint' => 'Max 50 chars'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('textarea'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Mary\View\Components\Textarea::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'catch_phrase','placeholder' => '...','rows' => '2','class' => 'focus:outline-orange-500 focus:border-orange-500 border-orange-500 peer-focus:label:text-orange-500']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginaleda28cbc945270b2059ee861cf34a6bc)): ?>
<?php $attributes = $__attributesOriginaleda28cbc945270b2059ee861cf34a6bc; ?>
...
<?php $component = Mary\View\Components\Input::resolve(['label' => 'Phone','icon' => 'o-phone'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'contact','placeholder' => '77 123 4567','class' => 'focus:outline-orange-500 focus:border-orange-500 border-orange-500 peer-focus:label:text-orange-500']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Mary\View\Components\Button::resolve(['label' => 'Save','spinner' => 'login'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
</div><?php /**PATH C:\Users\eugen\Documents\Workspace\sabrina-live\resources\views\livewire/edit-candidate-profile.blade.php ENDPATH**/ ?>