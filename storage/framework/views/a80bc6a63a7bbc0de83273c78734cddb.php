...
<?php $component = Mary\View\Components\Avatar::resolve(['image' => ''.e(asset('/storage/' . $candidate->profile_url)).'','title' => ''.e($candidate->fullName).'','subtitle' => ''.e($candidate->program).' - Part '.e($candidate->part).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
            ...
            <div>
                <img src="<?php echo e(asset('/storage/' . $candidate->profile_url)); ?>" alt="<?php echo e($candidate->fullName); ?>"
            ...
            <div class="p-4">
                <p class="mb-3 text-sm font-medium"><?php echo e($candidate->catch_phrase); ?></p>

                <div class="flex items-center gap-2">

                    <!--[if BLOCK]><![endif]--><?php if($this->voteStatus($candidate)): ?>
                        <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('bi-heart-fill'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(BladeUI\Icons\Components\Svg::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-6 h-6 cursor-pointer text-red-600','wire:click' => 'removeVote(\''.e($candidate->student_id).'\')']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('bi-heart'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(BladeUI\Icons\Components\Svg::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-6 h-6 cursor-pointer','wire:click' => 'vote(\''.e($candidate->student_id).'\')']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c)): ?>
<?php $attributes = $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
...
<?php endif; ?>
                    ...
                    <p class="font-semibold"><?php echo e($candidate->votes ?? 0); ?> votes</p>
                </div>
            </div>
    ...
    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
</div><?php /**PATH C:\Users\eugen\Documents\Workspace\sabrina\resources\views\livewire/voting-cards.blade.php ENDPATH**/ ?>