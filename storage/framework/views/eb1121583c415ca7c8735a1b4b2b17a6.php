...
<?php endif; ?>
<?php $component->withAttributes(['wire:submit.prevent' => 'apply','enctype' => 'multipart/form-data','class' => 'w-96']); ?>
        <div class="w-full flex justify-center">
            <div class="size-44 rounded-full overflow-hidden mb-3 ">
                <img x-show="showDefaultImg" src="<?php echo e(asset('no-profile.png')); ?>" alt="no-profile-img" class="s-full" />
        ...
        <div class="mb-3">
            ...
            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['profile_img'];
...
<?php $component = Mary\View\Components\Select::resolve(['label' => 'SRC Post','placeholder' => 'Select a Post','options' => $this->votingPosts,'optionValue' => 'src_post_id','optionLabel' => 'post'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'src_post_id','class' => 'focus:outline-orange-500 focus:border-orange-500 border-orange-500']); ?>
...
<?php $component = Mary\View\Components\Button::resolve(['label' => 'apply','icon' => 'o-paper-airplane','spinner' => 'save'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
</div><?php /**PATH C:\Users\eugen\Documents\Workspace\sabrina-live\resources\views\livewire/apply.blade.php ENDPATH**/ ?>