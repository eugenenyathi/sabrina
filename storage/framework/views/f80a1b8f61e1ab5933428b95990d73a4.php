...
<div>
    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $this->studentCouncil; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php $component = Mary\View\Components\Avatar::resolve(['image' => ''.e(asset('/storage/' . $student->profile_url)).'','title' => ''.e($student->fullName).'','subtitle' => ''.e($student->post).' - '.e($student->program).' - Part '.e($student->part).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
            ...
            <div>
                <img src="<?php echo e(asset('/storage/' . $student->profile_url)); ?>" alt="<?php echo e($student->fullName); ?> profile picture"
...
<?php endif; ?>
                    <p class="mb-3 text-sm font-medium"><?php echo e($student->contact); ?></p>
                </div>
            </div>

        </div>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
</div><?php /**PATH C:\Users\eugen\Documents\Workspace\sabrina-live\resources\views\livewire/studentcouncil.blade.php ENDPATH**/ ?>